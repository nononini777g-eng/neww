...
const initEmailJs = () => {
    // Check if the Email.js SDK is loaded
    if (typeof emailjs === 'undefined') {
        console.error('Email.js SDK not loaded. Cannot initialize contact form.');
        return;
    }

    // Initialize Email.js with a placeholder Public Key
    // NOTE: USER MUST REPLACE 'YOUR_EMAILJS_PUBLIC_KEY' with their actual key
    emailjs.init({
        publicKey: 'BwD9Ziwzy7NwXUe-J',
        // Optional: limit the rate of requests
        limitRate: {
    ...
    if (form) {
        form.addEventListener('submit', function(event) {
            ...
            emailjs.sendForm('service_5i6khps', 'template_kujb70x', this)
                .then(() => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initEmailJs(); // Initialize Email.js form handling
